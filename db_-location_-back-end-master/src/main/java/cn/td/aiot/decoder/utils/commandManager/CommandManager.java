...
import cn.td.aiot.decoder.utils.commandManager.util.ProgramUtil;
...
//	public static final ProgramConfig config=load("loadFFmpeg.properties", ProgramConfig.class);
	//TODO ProgramUtil.load未完成
	public static final ProgramConfig config=ProgramUtil.load("loadFFmpeg.properties", ProgramConfig.class);
	/**
	 * 注入自己实现的持久层
	 * 
	 * @param taskDao
