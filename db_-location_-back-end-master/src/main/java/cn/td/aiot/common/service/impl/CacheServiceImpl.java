package cn.td.aiot.common.service.impl;

import cn.td.aiot.common.domain.TiduConstant;
import cn.td.aiot.common.service.CacheService;
import cn.td.aiot.common.service.RedisService;
import cn.td.aiot.system.dao.UserMapper;
...
public class CacheServiceImpl implements CacheService {
    ...
    public User getUser(String username) throws Exception {
        String userString = this.redisService.get(TiduConstant.USER_CACHE_PREFIX + username);
    ...
    public List<Role> getRoles(String username) throws Exception {
        String roleListString = this.redisService.get(TiduConstant.USER_ROLE_CACHE_PREFIX + username);
    ...
    public List<Menu> getPermissions(String username) throws Exception {
        String permissionListString = this.redisService.get(TiduConstant.USER_PERMISSION_CACHE_PREFIX + username);
    ...
    public UserConfig getUserConfig(String userId) throws Exception {
        String userConfigString = this.redisService.get(TiduConstant.USER_CONFIG_CACHE_PREFIX + userId);
    ...
    public void saveUser(User user) throws Exception {
        ...
        redisService.set(TiduConstant.USER_CACHE_PREFIX + username, mapper.writeValueAsString(user));
    }
    ...
    public void saveRoles(String username) throws Exception {
        ...
        if (!roleList.isEmpty()) {
            ...
            redisService.set(TiduConstant.USER_ROLE_CACHE_PREFIX + username, mapper.writeValueAsString(roleList));
        }
    ...
    public void savePermissions(String username) throws Exception {
        ...
        if (!permissionList.isEmpty()) {
            ...
            redisService.set(TiduConstant.USER_PERMISSION_CACHE_PREFIX + username, mapper.writeValueAsString(permissionList));
        }
    }
    ...
    public void saveUserConfigs(String userId) throws Exception {
        ...
        if (userConfig != null) {
            ...
            redisService.set(TiduConstant.USER_CONFIG_CACHE_PREFIX + userId, mapper.writeValueAsString(userConfig));
        }
    }
    ...
    public void deleteUser(String username) throws Exception {
        ...
        redisService.del(TiduConstant.USER_CACHE_PREFIX + username);
    }

    @Override
    public void deleteRoles(String username) throws Exception {
        username = username.toLowerCase();
        redisService.del(TiduConstant.USER_ROLE_CACHE_PREFIX + username);
    }

    @Override
    public void deletePermissions(String username) throws Exception {
        username = username.toLowerCase();
        redisService.del(TiduConstant.USER_PERMISSION_CACHE_PREFIX + username);
    }

    @Override
    public void deleteUserConfigs(String userId) throws Exception {
        redisService.del(TiduConstant.USER_CONFIG_CACHE_PREFIX + userId);
    }
}
