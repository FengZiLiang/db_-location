...
import cn.td.aiot.system.service.DeptService;
...
public class DeptController extends BaseController {
    ...
    public void addDept(@Valid Dept dept) throws TdException {
        try {
    ...
    public void deleteDepts(@NotBlank(message = "{required}") @PathVariable String deptIds) throws TdException {
        try {
    ...
    public void updateDept(@Valid Dept dept) throws TdException {
        try {
    ...
    public void export(Dept dept, QueryRequest request, HttpServletResponse response) throws TdException {
        try {
