...
import cn.td.aiot.system.domain.Dict;
import cn.td.aiot.system.service.DictService;
...
public class DictController extends BaseController {
    ...
    public void addDict(@Valid Dict dict) throws TdException {
        try {
    ...
    public void deleteDicts(@NotBlank(message = "{required}") @PathVariable String dictIds) throws TdException {
        try {
    ...
    public void updateDict(@Valid Dict dict) throws TdException {
        try {
    ...
    public void export(QueryRequest request, Dict dict, HttpServletResponse response) throws TdException {
        try {
