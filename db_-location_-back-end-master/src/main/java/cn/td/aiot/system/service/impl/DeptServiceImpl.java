...
import cn.td.aiot.common.domain.Tree;
import cn.td.aiot.common.utils.SortUtil;
import cn.td.aiot.common.utils.TreeUtil;
import cn.td.aiot.system.dao.DeptMapper;
...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements DeptService {
    ...
    public List<Dept> findDepts(Dept dept, QueryRequest request) {
        ...
        SortUtil.handleWrapperSort(request, queryWrapper, "orderNum", TiduConstant.ORDER_ASC, true);
